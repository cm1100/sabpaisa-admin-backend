...
class BankWisePerformanceView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            # Simple aggregation using pg_name for demo
            bank_stats = TransactionDetail.objects.filter(query).values('pg_name').annotate(
            ...
            for bank_stat in bank_stats:
                bank_name = bank_stat['pg_name'] or 'Unknown Bank'
